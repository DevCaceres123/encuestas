...
@section('contenido')
    ...
    <div class="modal fade" id="modalAfiliadoEdit" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-center modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title " id="">
                        <span class="badge badge-outline-primary rounded">EDITAR NUEVO AFILIADO</span>
                    </h4>
                    <span class="ms-3 text-light">Campos obligatorios <strong class="text-danger">(*)</strong></span>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="formnuevo_afiliadoEdit">
                        <div class="container">
                            <div class="row">
                                {{-- datos personsales --}}
                                <div class=" row border border-3 rounded m-auto position-relative mt-3 ">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-danger rounded btn-sm" data-bs-dismiss="modal"> <i
                                    class="ri-close-line me-1 align-middle"></i> Cerrar</button>
                            <button type="submit" class="btn btn-success rounded btn-sm" id="btnnuevo_afiliadoEdit"><i
                                    class="ri-save-3-line me-1 align-middle"></i> guardar</button>
                        </div>
