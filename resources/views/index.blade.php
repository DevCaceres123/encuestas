...
<body>
    ...
    {{-- contactos y preloader --}}
    @include('plantilla_web.header')
    {{-- menu de la pagina --}}
    @include('plantilla_web.menu')
        ...
        <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                    ...
                    <div class="carousel-caption">
                        <div class="text-center p-4" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase fw-bold mb-3 mb-md-4 wow fadeInUp"
                                data-wow-delay="0.1s">Solution For All Type Of Visas</h4>
                            ...
                            <a class="btn btn-primary border-secondary rounded-pill text-white py-3 px-5 wow fadeInUp"
                                data-wow-delay="0.7s" href="index.html#">More Details</a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption">
                        <div class="text-center p-4" style="max-width: 900px;">
                            <h5 class="text-white text-uppercase fw-bold mb-3 mb-md-4 wow fadeInUp"
                                data-wow-delay="0.1s">Solution For All Type Of Visas</h5>
                            <h1 class="display-1 text-capitalize text-white mb-3 mb-md-4 wow fadeInUp"
                        ...
                        <div class="col-8 col-md-9">
                            ...
                            <div class="d-flex flex-wrap">
                                <div id="phone-tada" class="d-flex align-items-center justify-content-center me-4">
                                    <a href="index.html" class="position-relative wow tada" data-wow-delay=".9s">
                            ...
                            <div class="service-title">
                                <div class="service-title-name">
                                    <div class="bg-primary text-center rounded p-3 mx-5 mb-4">
                                        <a href="index.html#" class="h4 text-white mb-0">Job Visa</a>
                                    </div>
                                    <a class="btn bg-light text-secondary rounded-pill py-3 px-5 mb-4"
                                        href="index.html#">Explore More</a>
                                </div>
                    ...
                    <div class="service-item">
                        <div class="service-inner">
                            ...
                            <div class="service-title">
                                <div class="service-title-name">
                                    <div class="bg-primary text-center rounded p-3 mx-5 mb-4">
                                        <a href="index.html#" class="h4 text-white mb-0">Business Visa</a>
                                    </div>
                                    <a class="btn bg-light text-secondary rounded-pill py-3 px-5 mb-4"
                                        href="index.html#">Explore More</a>
                                </div>
                    ...
                    <div class="service-item">
                        <div class="service-inner">
                            ...
                            <div class="service-title">
                                <div class="service-title-name">
                                    <div class="bg-primary text-center rounded p-3 mx-5 mb-4">
                                        <a href="index.html#" class="h4 text-white mb-0">Diplometic Visa</a>
                                    </div>
                                    <a class="btn bg-light text-secondary rounded-pill py-3 px-5 mb-4"
                                        href="index.html#">Explore More</a>
                                </div>
                    ...
                    <div class="service-item">
                        <div class="service-inner">
                            ...
                            <div class="service-title">
                                <div class="service-title-name">
                                    <div class="bg-primary text-center rounded p-3 mx-5 mb-4">
                                        <a href="index.html#" class="h4 text-white mb-0">Students Visa</a>
                                    </div>
                                    <a class="btn bg-light text-secondary rounded-pill py-3 px-5 mb-4"
                                        href="index.html#">Explore More</a>
                                </div>
                    ...
                    <div class="service-item">
                        <div class="service-inner">
                            ...
                            <div class="service-title">
                                <div class="service-title-name">
                                    <div class="bg-primary text-center rounded p-3 mx-5 mb-4">
                                        <a href="index.html#" class="h4 text-white mb-0">Residence Visa</a>
                                    </div>
                                    <a class="btn bg-light text-secondary rounded-pill py-3 px-5 mb-4"
                                        href="index.html#">Explore More</a>
                                </div>
                    ...
                    <div class="service-item">
                        <div class="service-inner">
                            ...
                            <div class="service-title">
                                <div class="service-title-name">
                                    <div class="bg-primary text-center rounded p-3 mx-5 mb-4">
                                        <a href="index.html#" class="h4 text-white mb-0">Tourist Visa</a>
                                    </div>
                                    <a class="btn bg-light text-secondary rounded-pill py-3 px-5 mb-4"
                                        href="index.html#">Explore More</a>
                                </div>
            ...
            <div class="row g-4 justify-content-center text-center">
                    ...
                    <div class="feature-item text-center p-4">
                        ...
                        <div class="feature-content d-flex flex-column">
                            ...
                            <p class="mb-3">Dolor, sit amet consectetur adipisicing elit. Soluta inventore cum
                                accusamus,</p>
                            <a class="btn btn-secondary rounded-pill" href="index.html#">Read More<i
                ...
                <div class="col-12">
                    <a class="btn btn-primary border-secondary rounded-pill py-3 px-5 wow fadeInUp"
                        data-wow-delay="0.1s" href="index.html#">More Features</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-4 text-center">
                <div class="col-lg-6 col-xl-3 mb-5 mb-xl-0 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="country-item">
                        ...
                        <div class="country-name">
                            <a href="index.html#" class="text-white fs-4">Brazil</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-xl-3 mb-5 mb-xl-0 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="country-item">
                        ...
                        <div class="country-name">
                            <a href="index.html#" class="text-white fs-4">india</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-xl-3 mb-5 mb-xl-0 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="country-item">
                        ...
                        <div class="country-name">
                            <a href="index.html#" class="text-white fs-4">New York</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-xl-3 mb-5 mb-xl-0 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="country-item">
                        ...
                        <div class="country-name">
                            <a href="index.html#" class="text-white fs-4">Italy</a>
                        </div>
                    </div>
                </div>
                <div class="col-12">
                    <a class="btn btn-primary border-secondary rounded-pill py-3 px-5 wow fadeInUp"
                        data-wow-delay="0.1s" href="index.html#">More Countries</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container py-5">
            ...
            <div class="row g-4">
                    ...
                    <div class="training-item">
                        <div class="training-inner">
                            ...
                            <div class="training-title-name">
                                <a href="index.html#" class="h4 text-white mb-0">IELTS</a>
                                <a href="index.html#" class="h4 text-white mb-0">Coaching</a>
                            </div>
                        </div>
                        <div class="training-content bg-secondary rounded-bottom p-4">
                            ...
                            <p class="text-white-50">Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem,
                                veritatis.</p>
                            <a class="btn btn-secondary rounded-pill text-white p-0" href="index.html#">Read More <i
                ...
                <div class="col-lg-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="training-item">
                        <div class="training-inner">
                            ...
                            <div class="training-title-name">
                                <a href="index.html#" class="h4 text-white mb-0">TOEFL</a>
                                <a href="index.html#" class="h4 text-white mb-0">Coaching</a>
                            </div>
                        </div>
                        <div class="training-content bg-secondary rounded-bottom p-4">
                ...
                <div class="col-lg-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="training-item">
                        <div class="training-inner">
                            ...
                            <div class="training-title-name">
                                <a href="index.html#" class="h4 text-white mb-0">PTE</a>
                                <a href="index.html#" class="h4 text-white mb-0">Coaching</a>
                            </div>
                        </div>
                        <div class="training-content bg-secondary rounded-bottom p-4">
                ...
                <div class="col-lg-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="training-item">
                        <div class="training-inner">
                            ...
                            <div class="training-title-name">
                                <a href="index.html#" class="h4 text-white mb-0">OET</a>
                                <a href="index.html#" class="h4 text-white mb-0">Coaching</a>
                            </div>
                        </div>
                        <div class="training-content bg-secondary rounded-bottom p-4">
                ...
                <div class="col-12 text-center">
                    <a class="btn btn-primary border-secondary rounded-pill py-3 px-5 wow fadeInUp"
                        data-wow-delay="0.1s" href="index.html#">View More</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="office-item p-4">
                            ...
                            <div class="office-content d-flex flex-column">
                                ...
                                <a href="index.html#" class="text-secondary fs-5 mb-2">+123.456.7890</a>
                                <a href="index.html#" class="text-muted fs-5 mb-2">travisa@example.com</a>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="office-item p-4">
                            ...
                            <div class="office-content d-flex flex-column">
                                ...
                                <a href="index.html#" class="text-secondary fs-5 mb-2">(012) 0345 6789</a>
                                <a href="index.html#" class="text-muted fs-5 mb-2">travisa@example.com</a>
                                <p class="mb-0">123, First Floor, 123 St Roots Terrace, Los Angeles 90010 Unitd
                                    States of America.</p>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="office-item p-4">
                            ...
                            <div class="office-content d-flex flex-column">
                                ...
                                <a href="index.html#" class="text-secondary fs-5 mb-2">01234.567.890</a>
                                <a href="index.html#" class="text-muted fs-5 mb-2">travisa@example.com</a>
                                <p class="mb-0">123, First Floor, 123 St Roots Terrace, Los Angeles 90010 Unitd
                                    States of America.</p>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="office-item p-4">
                            ...
                            <div class="office-content d-flex flex-column">
                                ...
                                <a href="index.html#" class="text-secondary fs-5 mb-2">+123.45.67890</a>
                                <a href="index.html#" class="text-muted fs-5 mb-2">travisa@example.com</a>
                                <p class="mb-0">123, First Floor, 123 St Roots Terrace, Los Angeles 90010 Unitd
                                    States of America.</p>
                            </div>
            ...
            <div class="row g-5">
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <div class="footer-item d-flex flex-column">
                        ...
                        <a href="index.html"><i class="fa fa-map-marker-alt me-2"></i> 123 Street, New York, USA</a>
                        <a href="index.html"><i class="fas fa-envelope me-2"></i> info@example.com</a>
                        <a href="index.html"><i class="fas fa-phone me-2"></i> +012 345 67890</a>
                        <a href="index.html" class="mb-3"><i class="fas fa-print me-2"></i> +012 345 67890</a>
                        <div class="d-flex align-items-center">
                            <i class="fas fa-share fa-2x text-secondary me-2"></i>
                            <a class="btn mx-1" href="index.html"><i class="fab fa-facebook-f"></i></a>
                            <a class="btn mx-1" href="index.html"><i class="fab fa-twitter"></i></a>
                            <a class="btn mx-1" href="index.html"><i class="fab fa-instagram"></i></a>
                            <a class="btn mx-1" href="index.html"><i class="fab fa-linkedin-in"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 col-xl-3">
                ...
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <div class="footer-item d-flex flex-column">
                        ...
                        <a href="index.html#" class=""><i class="fas fa-angle-right me-2"></i> Business</a>
                        <a href="index.html#" class=""><i class="fas fa-angle-right me-2"></i> Evaluation</a>
                        <a href="index.html#" class=""><i class="fas fa-angle-right me-2"></i> Migrate</a>
                        <a href="index.html#" class=""><i class="fas fa-angle-right me-2"></i> Study</a>
                        <a href="index.html#" class=""><i class="fas fa-angle-right me-2"></i> Counselling</a>
                        <a href="index.html#" class=""><i class="fas fa-angle-right me-2"></i> Work /
                            Career</a>
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 col-xl-3">
    ...
    <!-- Back to Top -->
    <a href="index.html#" class="btn btn-primary btn-lg-square back-to-top"><i class="fa fa-arrow-up"></i></a>

    @include('plantilla_web.scripts')
</body>
