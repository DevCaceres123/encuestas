...
<head>
    ...
    <style>
        body {
            background: url('assets/fondo-login.webp') no-repeat center center;
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-4 mx-auto">
                                <div class="card rouneded" style="border:1px solid  rgb(46, 124, 69) !important ">
                                    <div class="card-body p-0 bg-black auth-header-box rounded-top">
                                        <div class="text-center p-3">
                                            <a href="index.html" class="logo logo-admin">
                                                <img src="{{ asset('assets/logo_alcaldia.png') }}" alt="logo"
                                                    class="auth-logo" height="150px" width="250">
                                            </a>
